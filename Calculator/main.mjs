...
var add_mjs_1 = require("./add.mjs");
var subtract_mjs_1 = require("./subtract.mjs");
var multiplication_mjs_1 = require("./multiplication.mjs");
var division_mjs_1 = require("./division.mjs");
...
do {
    console.log('hiiii');
    console.log(figlet_1.default.textSync("Calculator", { font: "Bloody" }));
    await main();
